...
def main():
    ...
    # 3. Clean Split Without Transform Leakage
    data_dir = r"C:\Users\nisch\OneDrive\Documents\paddy-disease-classification\train_images"
    
    # Create two separate instances to keep transforms completely independent
    ...
    # Stratified train/val split indices (preserves class ratios)
    ...
    # 5. Loss, Lower LR, & Cosine Scheduler
    criterion = nn.CrossEntropyLoss()
    optimizer = optim.Adam(model.parameters(), lr=1e-4, weight_decay=1e-4) # Lower LR (1e-4)
    ...
    torch.save(model.state_dict(), "googlenet_paddy.pth")
    print("\nModel saved to googlenet_paddy.pth")
    model.eval()
