...
def main():
    ...
    model.classifier[6]=nn.Linear(in_feature,num_classes)
    ...
    for epoch in range(num_epochs):
        ...
        for images, labels in train_loader:
            ...
            # Cleaned up GoogLeNet leftovers for ResNet18
        ...
        # -----------------------------------------
        # 3. END OF EPOCH CALCULATIONS
        # (Must be completely un-indented from the batch loop)
        # -----------------------------------------
        scheduler.step()
    ...
    torch.save(model.state_dict(), "vgg_paddy.pth")
    print("\nModel saved to vgg_paddy.pth")
