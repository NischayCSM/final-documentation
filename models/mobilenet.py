...
def main():
    ...
    # 4. Load MobileNetV2 & Adapt Classifier Head
    model = models.mobilenet_v2(weights=models.MobileNet_V2_Weights.DEFAULT)
    
    # Replace final linear layer in model.classifier[1]
    in_features = model.classifier[1].in_features
    model.classifier[1] = nn.Linear(in_features, num_classes)
    model = model.to(device)

    # 5. Loss, Learning Rate, & Cosine Scheduler
    ...
    for epoch in range(num_epochs):
        ...
        for images, labels in train_loader:
            ...
            # Standard forward pass (No aux logits to worry about)
    ...
    torch.save(model.state_dict(), "mobilenet_paddy.pth")
    print("\nModel saved to mobilenet_paddy.pth")
